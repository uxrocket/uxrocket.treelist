    ...
    $.extend(Treelist.prototype, {
        ...
        setHeaders: function() {
            ...
            this.headers.map(function(item) {
                ...
                item
                    .addClass(utils.getClassname('header'))
                ...
                if(item.find('> .' + utils.getClassname('toggle')).length === 0) {
        ...
        setContents: function() {
            this.contents.map(function(item) {
                item.addClass(utils.getClassname('content') + ' ' + utils.getClassname('collapsed'));
            });
        },
